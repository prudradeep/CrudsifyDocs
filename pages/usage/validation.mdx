...
Validation in the Crudsify framework is implemented with Joi. This includes validation of headers, param/s, query and body. Joi validation models are based primarily on of each model's field properties. Below is a list of sequelize data types and their joi equivalent within Crudsify:
...
If you create standalone or additional endpoints, you must wrap validate properties in Joi.object for body, param/s or query as described below:
