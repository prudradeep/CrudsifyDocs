...
However we can further populate each user's **title** field with a nested **$embed** parameter: **/group?$embed=user.group** which could result in the following response:
